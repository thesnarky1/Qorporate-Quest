<?php
    ...
    echo "Your goal while employed at &lt;Company Name&gt; is to pursue your career, have fun, and most importantly, slave at your desk for 15 hours a day to make sure the TPS reports get out on time!";
    echo "</p>\n";
